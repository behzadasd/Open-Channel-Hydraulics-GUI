function [Profile_t, Ch_Yn, A_Area_t, P_Perimeter_t] = PSO_Solver_Q_Yn (X_min, X_max, Ch_Q, Ch_n, Ch_S, man_n_c, Profile_datum)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% --- calculation %%%
[Profile_t, A_Area_t, P_Perimeter_t ] = hydro_Area(Profile_datum, Ch_Yn );
